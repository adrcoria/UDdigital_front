...
const handleSave = async () => {
    ...
    try {
        ...
        // CONTRATO EXACTO DE TU POSTMAN
        const payload = {
            idBovines: selectedBovineIds.value // El array de IDs de animales
        };

        await batchBovineService.updateBovinestoBatch(props.batch.id, payload);
